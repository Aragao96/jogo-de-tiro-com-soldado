...
soldado1 = pygame.image.load(os.path.join('/home/karenrafael/Documentos/fps_de_soldados/jogo-de-tiro-com-soldado/sordadin.jpg'))
sordado1 = pygame.transform.scale(soldado1, (space_width, space_heigth))
soldado2 = pygame.image.load(os.path.join('/home/karenrafael/Documentos/fps_de_soldados/jogo-de-tiro-com-soldado/sordadin2.png'))
